  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <PageHero 
        ...
        description="Des chiffres qui témoignent de notre impact réel sur le terrain et de notre contribution à la transformation du secteur semencier africain."
      />
